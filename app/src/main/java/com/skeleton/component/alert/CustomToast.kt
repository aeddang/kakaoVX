...
object CustomToast {
    ...
    fun makeToast(context: Context, body: Int, duration: Int = Toast.LENGTH_SHORT): Toast {
        return makeToast(context, context.getString(body), duration)
    }

    @SuppressLint("ShowToast")
    fun makeToast(context: Context, body: String, duration: Int = Toast.LENGTH_SHORT): Toast {
